...
[
  ...
  ;; parking strategy string flag
  ;; agent-strategy ;; 'possible prior strategies:' ('same-place', 'nearest-region', 'reserved-spot')
]
...
[
  ...
  top-left-distance ;; rana.1.a: distance to top-left of map
  bottom-left-distance ;; rana.1.a: distance to bottom-left of map
  top-right-distance ;; rana.1.a: distance to top-right of map
  bottom-right-distance ;; rana.1.a: distance to bottom-right of map
