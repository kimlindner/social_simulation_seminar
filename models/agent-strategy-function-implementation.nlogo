...
to set-navgoal
  let max-distance min [center-distance] of potential-goals
...
;; draw parking strategy distribution based on Polak et al., Parking Search Behaviour
to-report draw-uninformed-strategy-value
  ...
  let switch-value random total-value-bound
